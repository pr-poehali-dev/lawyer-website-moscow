  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-[#25D366] hover:bg-[#20BA5A] rounded-full flex items-center justify-center shadow-2xl transition-all hover:scale-110"
